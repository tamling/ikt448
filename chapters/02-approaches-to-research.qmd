...
Mixed methods have their own guidelines in our field. Venkatesh, Brown and Bala (2013) ask three questions: whether a mixed methods approach is appropriate for the question at all; how meta-inferences --- the conclusions that integrate both strands --- are developed; and how their quality is validated. They list seven purposes for combining the strands: complementarity, completeness, developmental sequencing, expansion, corroboration or confirmation, compensation, and diversity. Venkatesh, Brown and Sullivan (2016) turn the guidelines into fourteen design properties with a decision tree, from the research questions and the paradigm stance to the mixing strategy, the timing of the strands and the validation of inferences. For your essay the consequence is simple: a mixed-methods proposal states its purpose in these terms, the sequence of the strands, which strand has priority, and where the two are integrated. Without these four decisions it is two studies, not one. The two papers have since grown into an open-access textbook, Venkatesh, Brown and Sullivan's *Conducting Mixed-Methods Research* (2023), whose thirteen chapters run from mixed methods as the third research approach to paper templates and advice for reviewers. Chapter 4 treats the appropriateness of the approach and the seven purposes; Chapter 5 sets out five aspects of design --- the investigation strategy, exploratory or confirmatory; the strands of the study; the time orientation, concurrent or sequential; the priority of the approaches; and the mixing strategy --- and connects them to the purpose in a decision model; Chapter 10 explains how meta-inferences are generated; and Chapter 11 supplies the paper templates that Session 11 returns to. The book is in the reading folder. The same authors have since collected the guidelines, the design decisions and worked examples from published research in an open-access book (Venkatesh, Brown & Sullivan, 2023), which is the reference to consult when a mixed-methods design is actually planned.
...
*For your essay: a mixed-methods proposal states the purpose, the sequence of strands, which strand has priority, and where the two are integrated. Without these four decisions it is two studies, not one. The full treatment, with worked examples from published research, is the same authors' open-access book (Venkatesh, Brown & Sullivan, 2023).*
...
-   Venkatesh, V., Brown, S., & Sullivan, Y. (2023). *Conducting mixed-methods research: From classical social sciences to the age of big data and analytics*. Virginia Tech Pamplin College of Business and Virginia Tech Publishing. <https://doi.org/10.21061/conducting-mixed-methods-research>
